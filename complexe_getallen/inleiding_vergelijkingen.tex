...
\begin{image}
    \begin{tikzpicture}
    % Ellipse for real numbers R
    \draw[thick] (3,0) ellipse (5.25cm and 1.6cm) node[right=5.25cm] {\Large $\mathbb{R}$};
    
    % Ellipse for rational numbers Q
    \draw[thick] (2,0) ellipse (4cm and 1.4cm) node[right=4cm] {\Large $\mathbb{Q}$};
    
    % Ellipse for integers Z
    \draw[thick] (1,0) ellipse (2.75cm and 1.2cm) node[right=2.75cm] {\Large $\mathbb{Z}$};
    
    % Ellipse for natural numbers N
    \draw[thick] (0,0) ellipse (1.5cm and 0.8cm) node[right=1.5cm] {\Large $\mathbb{N}$};
