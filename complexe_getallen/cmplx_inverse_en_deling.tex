...
\begin{document}
    ...
    \formulevb{z^{-1} = \frac{1}{z} = \frac{\overline{z}}{|z|^2}}{(3+4i)^{-1}=\frac{1}{3+4i} = \frac{3-4i}{25}= \frac{3}{25}-\frac{4}{25}i}
    \end{proposition}
    ...
    \begin{proposition} Voor een complexe getal $z$ en $w$ geldt
        \formulevb{\frac{w}{z} = \frac{w\cdot\overline{z}}{|z|^2}}{\frac{1+2i}{3+4i} = \frac{(1+2i)(3-4i)}{25}= \frac{11}{25}+\frac{2}{25}i}
    \end{proposition}
